...
export async function GET() {
  ...
  const guide = [
    ...
    ["NIK", "Gunakan NIK 7 digit. Jika NIK diawali angka 0, pertahankan angka 0 tersebut. Gunakan NIK yang sama untuk orang yang sama pada setiap tahun pelajaran."],
  ...
  const profileRows = [
    ...
    ["2025/2026","0124837","Andi Pratama","Pria","PKWTT","Non-Kasek","Guru Nasional","SMPK PENABUR Gading Serpong","PGS","SMP","SMP","NASIONAL","Bahasa Indonesia","Satu Jenjang","7A","Tidak","Tidak",24],
    ["2025/2026","0217594","Sinta Maharani","Wanita","PKWTT","Non-Kasek","Guru Bilingual","SDK PENABUR Gading Serpong","DGS","SD","SD","BILINGUAL","Tematik","Satu Jenjang","3A","Tidak","Tidak",33],
    ["2025/2026","0346812","Rina Wijaya","Wanita","PKWTT","Non-Kasek","Guru Internasional","PENABUR Intercultural School - Primary Kelapa Gading","DKG","Primary","Internasional","INTERNASIONAL","SEMUA","Satu Jenjang","3C","Tidak","Tidak",22],
    ["2025/2026","0459271","Dedi Kurniawan","Pria","PKWTT","Non-Kasek","Guru Nasional","SMAK 7 PENABUR","A07","SLTA","SLTA","NASIONAL","Ekonomi","Satu Jenjang","X-2","Ya","Tidak",16],
    ["2025/2026","0583146","Maya Lestari","Wanita","PKWTT","Non-Kasek","Guru Nasional","SMAK 1 PENABUR","A01","SLTA","SLTA","NASIONAL","BK (Bimbingan Konseling)","Satu Jenjang","-","Tidak","Ya",24],
  ];
  ...
  const assignmentRows = [
    ...
    ["2025/2026","0124837","SMPK PENABUR Gading Serpong","Bahasa Indonesia","7A",12,"Ya"],
    ["2025/2026","0124837","SMPK PENABUR Gading Serpong","Bahasa Indonesia","7B",12,"Tidak"],
    ["2025/2026","0217594","SDK PENABUR Gading Serpong","Tematik","3A",33,"Ya"],
    ["2025/2026","0346812","PENABUR Intercultural School - Primary Kelapa Gading","SEMUA","3C",22,"Ya"],
    ["2025/2026","0459271","SMAK 7 PENABUR","Ekonomi","X-2",16,"Ya"],
    ["2025/2026","0583146","SMAK 1 PENABUR","BK (Bimbingan Konseling)","-",24,"Ya"],
  ];
  ...
  const taskRows = [
    ...
    ["2025/2026","0217594","Wali Kelas","Wali Kelas",3,"Ya"],
    ["2025/2026","0346812","Koordinator Level Primary","Koordinator Level Primary",3,"Ya"],
    ["2025/2026","0346812","Wali Kelas","Wali Kelas",3,"Tidak"],
    ["2025/2026","0459271","Wakil Kepala Sekolah","Wakasek",12,"Ya"],
  ];
  ...
  const refs = [
    ...
    ["NIK", "7 digit, contoh 0124837; pertahankan angka 0 di depan"],
